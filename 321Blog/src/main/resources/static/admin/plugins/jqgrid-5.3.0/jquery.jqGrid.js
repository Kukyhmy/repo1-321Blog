	...
	return this.each( function() {
		...
		*/
		...
		this.createTableRowForRule = function(rule, group ) {
			// save current entity0 in a variable so that it could
	...
	setGroupHeaders : function ( o ) {
		...
		return this.each(function(){
			...
			if (o.useColSpanStyle) {
				...
				// Set position of the sortable div (the basics lable)
...
//module begin
	...
	$.fn.fmatter = function(formatType, cellval, opts, rwd, act) {
		// build basics options before element iteration
		var v=cellval;
	...
	excelStrings  : {
		...
		"[Content_Types].xml":
			...
			'<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">'+
				...
				'<Override PartName="/xl/workbook.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.basics+xml" />'+
