...
(function ($) {
  ...
  var $navbar_border = $('<input />', {
    type   : 'checkbox',
    value  : 1,
    checked: $('.basics-header').hasClass('border-bottom'),
    'class': 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.basics-header').addClass('border-bottom')
    } else {
      $('.basics-header').removeClass('border-bottom')
    }
