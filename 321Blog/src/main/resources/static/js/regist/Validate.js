...
var validatePrompt = {
    username:{
        ...
        isNull:"请输入用户名",
        error:{
            beUsed:"该用户名已被使用，请使用其它用户名注册，如果您是&quot;{1}&quot;，请<a href='https://www.321blog.com' class='flk13'>登录</a>",
    ...
    mail:{
        ...
        isNull:"请输入邮箱",
        error:{
            beUsed:"该邮箱已被使用，请更换其它邮箱，或使用该邮箱<a href='http://www.321blog.com' class='flk13'>找回密码</a>",
            badFormat:"邮箱格式不正确",
